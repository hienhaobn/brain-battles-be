...
) => ThisType<TypeOrmRepository<ObjectLiteral>>;
		...
		return {
			...
			useFactory: (dataSource: DataSource) => {
				return dataSource.options.type === 'mongodb'
					? Object.assign(dataSource.getMongoRepository(entity), new repo(entity, dataSource.manager))
					: Object.assign(dataSource.getRepository(entity), new repo(entity, dataSource.manager));
			},
